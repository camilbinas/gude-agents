...
require (
	...
	github.com/camilbinas/gude-agents/agent/provider/ollama v0.55.1
...
require (
	...
	github.com/camilbinas/gude-agents/agent/rag/bedrock v0.55.1 // indirect
	github.com/camilbinas/gude-agents/agent/rag/gemini v0.55.1 // indirect
	github.com/camilbinas/gude-agents/agent/rag/openai v0.55.1 // indirect

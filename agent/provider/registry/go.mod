...
require (
	...
	github.com/camilbinas/gude-agents/agent/provider/ollama v0.24.0
...
require (
	...
	github.com/camilbinas/gude-agents/agent/rag/bedrock v0.24.0 // indirect
	github.com/camilbinas/gude-agents/agent/rag/gemini v0.24.0 // indirect
	github.com/camilbinas/gude-agents/agent/rag/openai v0.24.0 // indirect

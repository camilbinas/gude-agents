...
require (
	...
	github.com/camilbinas/gude-agents/agent/provider/gemini v0.11.0
	github.com/camilbinas/gude-agents/agent/provider/ollama v0.11.0
...
require (
	...
	github.com/camilbinas/gude-agents/agent/rag/bedrock v0.11.0 // indirect

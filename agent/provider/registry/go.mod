...
require (
	...
	github.com/camilbinas/gude-agents/agent/provider/gemini v0.22.0
	github.com/camilbinas/gude-agents/agent/provider/ollama v0.22.0
...
require (
	...
	github.com/camilbinas/gude-agents/agent/rag/bedrock v0.22.0 // indirect
	github.com/camilbinas/gude-agents/agent/rag/gemini v0.22.0 // indirect
